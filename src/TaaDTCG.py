...
##        self.traces = traces
        ...
        self.nodeMap = {}
        self.automataDir = "C:\Users\ASTROHSU\Desktop\Exp\traces\MN\org.cwb\version1\abstraction1\session12\sessionAutomata",'UTF-8'
        task.setParentPath("C:\Users\ASTROHSU\Desktop\Exp\traces\MN\org.cwb",'UTF-8')
        task.getAutomataByDir("C:\Users\ASTROHSU\Desktop\Exp\traces\MN\org.cwb\version1\abstraction1\session12\sessionAutomata","TestCaseGenerator2",'UTF-8')
        self.ruleInList = []
        self.shortestPath = []
        failStateList = []
